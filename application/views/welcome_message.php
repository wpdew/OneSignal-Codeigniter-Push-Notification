...
<body>
	<div id="container">
		...
		<hr />
        <p><b>Code on github: <a href="https://github.com/pomerla/OneSignal-Codeigniter-Push-Notification" target="_blank">OneSignal-Codeigniter-Push-Notification</a></b> </p>
        <hr />
        <p>To enable OneSignal on your site, you will need to paste the code from Web Push Settings into your website's &lt; head &gt;. If you do not have access to modify your site's code, you will need to contact a developer to help you.</p>
        <p>Example of use on this site</p>
